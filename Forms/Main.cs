...
namespace XBLMarketplace_For_PC.Forms
{
    public class Main : Form
    {
        ...
        private TabPage Marketplace_tabPage;
        private TableLayoutPanel tableLayoutPanel2;
        private GroupBox region_group;
        ...
        private Label entrypp_label;
        private NumericUpDown entrys_num;
        private GroupBox contentdescription_group;
        private TableLayoutPanel tableLayoutPanel5;
        private PictureBox display_pic;
        private TableLayoutPanel tableLayoutPanel8;
        private TextBox gametitle_text;
        private TextBox developer_text;
        private TextBox publisher_text;
        private TextBox release_text;
        private TextBox genre_text;
        private Label gametitle_label;
        private Label developer_label;
        private Label publisher_label;
        private Label releasedate_label;
        private Label genre_label;
        private GroupBox download_group;
        private TableLayoutPanel tableLayoutPanel9;
        private Button directdownload_btn;
        private Button generateurl_btn;
        private Button fchecklist_btn;
        private RichTextBox description_textbox;
        private TabPage InfoAndSettings_tabPage;
        private TableLayoutPanel tableLayoutPanel12;
        private GroupBox extrainfo_group;
        private GroupBox credits_changelog_gbox;
        private TableLayoutPanel tableLayoutPanel11;
        private Label cat_label;
        private Label filler_label1;
        private Label cat_sync_label;
        private Label filler_label2;
        private Label filler_label3;
        private Label filler_label4;
        private Label numofitems_label;
        private Label numitems_sync_label;
        private Label filler_label6;
        private Label filler_label5;
        private Label updateddate_label;
        private Label updated_sync_label;
        private GroupBox settings_group;
        private TableLayoutPanel tableLayoutPanel14;
        private TableLayoutPanel tableLayoutPanel13;
        private Label filler_label_af;
        private Label filler_label_ae;
        private Label filler_label_ad;
        private Label filler_label_ac;
        private Label filler_label_ab;
        private Label filler_label_aa;
        private Label filler_label_f;
        private Label filler_label_e;
        private Label filler_label_c;
        private Label filler_label_d;
        private Label filler_label_b;
        private Label filler_label_a;
        private Label setting_label_Query_Language;
        private Label setting_label_useragent;
        private Label setting_label_batchdelay;
        private Label setting_label_decompressTo;
        private Label setting_label_downloadTo;
        private Label setting_label_IsoTo;
        private ComboBox querylanguage_sel;
        private Label extrainfo_Label;
        private Button extrainfo_btn;
        private ComboBox useragent_sel;
        private TableLayoutPanel tableLayoutPanel15;
        private RichTextBox richTextBox1;
        private Label displayVersionLabelnomodify;
        private NumericUpDown batchdelay_updown;
        private Label batchdelay_label2;
        private Label versionval_label;
        private Button About_btn;
        private TabPage Downloads_tabPage;
        private StatusStrip statusStrip1;
        private ToolStripStatusLabel tsslNoChange1;
        private ToolStripStatusLabel DownloadSpeed_tssl;
        private TableLayoutPanel Downloads_tlp;
        ...
        private TextBox decompress_path_tb;
        private Button decompress_path_browse_btn;
        private TextBox download_path_tb;
        private TextBox iso_path_tb;
        private Button download_path_browse_btn;
        private Button iso_path_browse_btn;
        private TabPage converter_tabPage;
        ...
        private Button xcptogod_cancel_btn;
        private Button godtoiso_cancel_btn;
        private BetterListViewEx xcptogod_blvex;
        private BetterListViewEx godtoiso_blvex;
        private Button xcptogod_Add_btn;
        private Button xcptogod_Remove_btn;
        private Button xcptogod_Unpack_btn;
        private Button xcptogod_UnpackAll_btn;
        private Button xcptogod_RemoveFinished_btn;
        private Button godtoiso_Add_btn;
        private Button godtoiso_Remove_btn;
        private Button godtoiso_CreateIso_btn;
        private Button godtoiso_RemoveFinished_btn;
        private Button godtoiso_ConvertAll_btn;
        private Button downloadmanager_controls_Remove_btn;
        ...
        {
            this._xcpList = new ThreadedBindingList<XcpInstance>();
            this._godList = new ThreadedBindingList<GameOnDemand>();
            this._isoList = new ThreadedBindingList<IsoInstance>();
            this.xcptogod_blvex.DataSource = (object)this._xcpList;
            this.godtoiso_blvex.DataSource = (object)this._godList;
        }
        ...
        private void xcptogod_Add_btn_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.InitialDirectory = BindingStrings.Instance.DownloadPath;
            openFileDialog1.Filter = "Xbox Package(*.xcp;*.xup) |*.xcp;*.xup| All files(*.*) | *.*";
            openFileDialog1.Title = "Open File...";
            using (OpenFileDialog openFileDialog2 = openFileDialog1)
            {
                if (openFileDialog2.ShowDialog() != DialogResult.OK)
                    return;
                this._xcpList.Add(new XcpInstance(openFileDialog2.FileName, BindingStrings.Instance.DecompressPath, Main.ConverterOptions.autostart, Main.ConverterOptions.cleanup, (PackageBase)null));
            }
        }
        ...
        {
            XcpInstance xcp = (XcpInstance)this.xcptogod_blvex.SelectedValue;
            if (xcp == null)
            {
                ...
                Task.Run((Action)(() =>
               {
                   ...
                   {
                       xcp.UnpackAndSplitComplete += new EventHandler(this.Xcp_UnpackAndSplitComplete);
                       xcp.FullExtract();
                   }
                   else
                   {
                       if (string.Compare(Path.GetExtension(xcp.InFile), ".xup", StringComparison.OrdinalIgnoreCase) != 0)
                           return;
                       xcp.UnpackCompleted += new EventHandler(this.Xcp_UnpackCompleted);
                       xcp.Split();
                   }
               })).ContinueWith((Action<Task>)(prevTask =>
       {
           if (prevTask.Exception != null)
               throw prevTask.Exception;
           if (xcp.GodInstance == null)
               return;
           this._godList.Add(xcp.GodInstance);
           this._xcpList.Remove(xcp);
       }));
        }
        ...
        private void xcptogod_RemoveFinished_btn_Click(object sender, EventArgs e)
        {
            try
            {
                foreach (BetterListViewItem betterListViewItem in this.xcptogod_blvex.Items.Where<BetterListViewItem>((Func<BetterListViewItem, bool>)(obj => ((XcpInstance)obj.Value).GodInstance != null)).ToList<BetterListViewItem>())
                    this.xcptogod_blvex.Items.Remove(betterListViewItem);
            }
            catch (Exception ex)
            {
        ...
        private void godtoiso_Add_btn_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.DereferenceLinks = true;
            openFileDialog1.Multiselect = false;
            openFileDialog1.InitialDirectory = BindingStrings.Instance.DecompressPath;
            openFileDialog1.Filter = "Pirs Header|";
            openFileDialog1.Title = "Open File...";
            using (OpenFileDialog openFileDialog2 = openFileDialog1)
            {
                if (openFileDialog2.ShowDialog() != DialogResult.OK)
                    return;
                this._godList.Add(new GameOnDemand(new Pirs(openFileDialog2.FileName)));
            }
        }

        private void godtoiso_Remove_btn_Click(object sender, EventArgs e)
        {
            GameOnDemand selectedValue = (GameOnDemand)this.godtoiso_blvex.SelectedValue;
            ...
            {
                this._godList.Remove(selectedValue);
            }
            else
            {
        ...
        {
            GameOnDemand god = (GameOnDemand)this.godtoiso_blvex.SelectedValue;
            if (god == null)
            {
                int num = (int)MessageBox.Show("Please Select a Game to Convert", "Alert");
            }
            else
                Task.Run((Action)(() => god.CreateIso(BindingStrings.Instance.IsoPath, Main.ConverterOptions.fixcbHeader))).ContinueWith((Action<Task>)(prevTask =>
              {
                  if (prevTask.Exception != null)
                      throw prevTask.Exception;
              }));
        ...
        private void godtoiso_RemoveFinished_btn_Click(object sender, EventArgs e)
        {
            try
            {
                foreach (BetterListViewItem betterListViewItem in this.godtoiso_blvex.Items.Where<BetterListViewItem>((Func<BetterListViewItem, bool>)(obj =>
               {
                   ...
                   return gameOnDemand.Status == PackageStatus.Canceled || gameOnDemand.Status == PackageStatus.Finished || gameOnDemand.Status == PackageStatus.Errored;
                    ...
                    this.godtoiso_blvex.Items.Remove(betterListViewItem);
            }
            catch (Exception ex)
            {
                Console.Write(ex.ToString());
        ...
        private void Xcp_UnpackAndSplitComplete(object sender, EventArgs e)
        {
            ...
            xcpInstance.UnpackAndSplitComplete -= new EventHandler(this.Xcp_UnpackAndSplitComplete);
            this._xcpList.Remove(xcpInstance);
        }

        private void Xcp_UnpackCompleted(object sender, EventArgs e)
        {
            XcpInstance xcpInstance = (XcpInstance)sender;
            xcpInstance.UnpackCompleted -= new EventHandler(this.Xcp_UnpackCompleted);
            this._xcpList.Remove(xcpInstance);
        }

        private void God_CreateIsoProgress(object sender, JasonNS.EventArguments.ProgressChangedEventArgs e) => this._godList.ResetItem(this._godList.IndexOf((GameOnDemand)sender));

        private void download_init()
        {
            this._downloads = new ThreadedBindingList<DownloadInstance>();
            this.downloadmanager_blv.DataSource = (object)this._downloads;
            foreach (BetterListViewColumnHeader column in (BetterListViewElementCollection<BetterListViewColumnHeader>)this.downloadmanager_blv.Columns)
        ...
        private void download_Contentdl_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            if (Main.ConverterOptions.autostart)
                this._downloads.FirstOrDefault<DownloadInstance>((Func<DownloadInstance, bool>)(d => d.DLStatus == DownloadStatus.Waiting))?.StartDownload();
            DownloadInstance userState = (DownloadInstance)e.UserState;
            userState.ProgressChanged -= new DownloadProgressChangedEventHandler(this.download_Contentdl_ProgressChanged);
            userState.DownloadFileCompleted -= new AsyncCompletedEventHandler(this.download_Contentdl_DownloadFileCompleted);
            userState.CancelDownload();
            this._xcpList.Add(userState.GetXcpInstance);
            userState.Dispose();
        }

        private void download_Contentdl_ProgressChanged(
          object sender,
          DownloadProgressChangedEventArgs e)
        {
            this._downloads.ResetItem(this._downloads.IndexOf((DownloadInstance)e.UserState));
        }

        private void marketplace_init()
        {
            this._batchhandler = new BatchUrlChecker(new ThreadedBindingList<MarketPlaceContent>(), SynchronizationContext.Current);
            this._content = this._batchhandler._content;
            this._helper.XmlDocLoaded += new EventHandler(this.marketplace_XmlDocChanged);
            this._batchhandler.ProgressChangedEnd += new ProgressChangedEventHandler(this.marketplace_urlChecking_ProgressBar_Progress);
            try
            {
                this.entrys_num.Value = (Decimal)Settings.Default.entry_per_page;
                this.page_num.Maximum = (Decimal)Settings.Default.last_page_viewed;
                this.page_num.Value = (Decimal)Settings.Default.last_page_viewed;
                this.batchdelay_updown.Value = (Decimal)Settings.Default.batchdelay;
                this.cat_select.DataSource = (object)Constants.BindingLists.Categorys;
                this.cat_select.DisplayMember = "name";
                this.cat_select.SelectedIndex = Settings.Default.mediaindex;
                this._helper.MediaTypes = (MediaId)this.cat_select.SelectedItem;
                this.cat_select.SelectedIndexChanged += new EventHandler(this.setting_marketplace_cat_select_SelectedIndexChanged);
                this.reg_select.DataSource = (object)Constants.BindingLists.Regions;
                this.reg_select.DisplayMember = "name";
                this.reg_select.SelectedIndex = Settings.Default.regionindex;
                this._helper.Locales = (RegionId)this.reg_select.SelectedItem;
                this.reg_select.SelectedIndexChanged += new EventHandler(this.setting_marketplace_reg_select_SelectedIndexChanged);
                this.querylanguage_sel.DataSource = (object)Constants.BindingLists.Languages;
                this.querylanguage_sel.DisplayMember = "id";
                this.querylanguage_sel.SelectedIndex = Settings.Default.languageindex;
                this._helper.Language = (Language)this.querylanguage_sel.SelectedItem;
                this.querylanguage_sel.SelectedValueChanged += new EventHandler(this.setting_marketplace_querylanguage_sel_SelectedIndexChanged);
                this.versionval_label.Text = "R1.8.1";
                this._batchhandler.NetworkDelay = Convert.ToInt32(this.batchdelay_updown.Value);
                this._helper.PageSize = this.entrys_num.Value.ToString();
                this._helper.PageNum = this.page_num.Value.ToString();
                this._helper.SubmitQuery();
                this.contentview.DataSource = (object)this._content;
                this.marketplace_ContentViewResize();
            }
            catch (Exception ex)
            {
        ...
        {
            this.marketplace_MaxPageUpdate();
            Settings.Default.entry_per_page = (int)this.entrys_num.Value;
            this._helper.PageSize = this.entrys_num.Value.ToString();
        ...
        {
            Settings.Default.last_page_viewed = (int)this.page_num.Value;
            this._helper.PageNum = this.page_num.Value.ToString();
            Settings.Default.Save();
        }
        ...
        private void setting_marketplace_cat_select_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.marketplace_MaxPageUpdate();
            this._helper.MediaTypes = (MediaId)this.cat_select.SelectedItem;
            Settings.Default.mediaindex = this.cat_select.SelectedIndex;
            Settings.Default.Save();
        }
        ...
        {
            this._helper.Locales = (RegionId)this.reg_select.SelectedItem;
            Settings.Default.regionindex = this.reg_select.SelectedIndex;
            Settings.Default.Save();
        }
        ...
        {
            this._helper.Language = (Language)this.querylanguage_sel.SelectedItem;
            Settings.Default.languageindex = this.querylanguage_sel.SelectedIndex;
            Settings.Default.Save();
        }
        ...
        {
            this._batchhandler.NetworkDelay = Convert.ToInt32(this.batchdelay_updown.Value);
            Settings.Default.batchdelay = this._batchhandler.NetworkDelay;
            Settings.Default.Save();
        }

        private void marketplace_XmlDocChanged(object sender, EventArgs a)
        {
            this.contentview.SuppressSelectionChanged();
            this._content.RaiseListChangedEvents = false;
            this._batchhandler.Abort();
            this._content.Clear();
            XDocument xmlDoc = this._helper.XmlDoc;
            if (xmlDoc != null)
            {
                foreach (XElement descendant in xmlDoc.Descendants(Constants.NetworkConnectivity.Namespaces.Atom + "entry"))
                {
                    MarketPlaceContent marketPlaceContent = new MarketPlaceContent(descendant, (Language)this.querylanguage_sel.SelectedItem);
                    marketPlaceContent.Load();
                    this._content.Add(marketPlaceContent);
                }
                this.numitems_sync_label.Text = xmlDoc.Descendants(Constants.NetworkConnectivity.Namespaces.Live + "totalItems").First<XElement>().Value;
                this.cat_sync_label.Text = this._helper.MediaTypes.Name;
                int result;
                if (int.TryParse(this.numitems_sync_label.Text, out result))
                {
                    int num = (int)Math.Ceiling((Decimal)result / this.entrys_num.Value);
                    if ((Decimal)num < this.page_num.Value)
                        this.page_num.Value = (Decimal)num;
                    this.page_num.Maximum = (Decimal)num;
                    Constants.BindingLists.Categorys[Constants.BindingLists.Categorys.IndexOf((MediaId)this.cat_select.SelectedItem)].TotalCount = result;
                }
            }
            this._content.RaiseListChangedEvents = true;
            this._content.ResetBindings();
            this._batchhandler.StartUrlCheck(false);
            this.contentview.ResumeSelectionChanged();
        }
        ...
        {
            this.urlChecking_ProgressBar.Value = e.ProgressPercentage;
        }
          ...
          BetterListViewSelectedItemsChangedEventArgs eventArgs)
        {
            ...
            try
            {
                this._prevItem?.Tokensource?.Cancel();
            }
            catch (ObjectDisposedException ex)
            {
                this._prevItem = (MarketPlaceContent)null;
            }
            if (this._prevItem != null && this._content.Contains(this._prevItem))
                this.display_pic.Image = (Image)null;
            if (this.contentview.SelectedValue == null)
                return;
            MarketPlaceContent item = (MarketPlaceContent)this.contentview.SelectedValue;
            this.gametitle_text.Text = item.Title;
            this.developer_text.Text = item.Developer;
            this.publisher_text.Text = item.Publisher;
            this.release_text.Text = item.Releasedate.ToString((IFormatProvider)CultureInfo.CurrentCulture);
            this.genre_text.Text = item.OffersCount;
            this.description_textbox.Text = item.Description;
            if (item.Thumb == null && item.Thumburl != null)
                item.InitImageAsync(item.Thumburl).ContinueWith((Action<Task<Image>>)(task =>
               {
                   if (item.Tokensource == null)
                       return;
                   this.display_pic.Image = task.Result;
                   item.Tokensource = (CancellationTokenSource)null;
               }), item.Tokensource.Token);
            else if (item.Thumb != null)
                this.display_pic.Image = item.Thumb;
            Image image = this.display_pic.Image;
            this._prevItem = item;
            if (item.Capabilities == null)
                this.extrainfo_btn.Enabled = false;
            else
                this.extrainfo_btn.Enabled = true;
        }

        private void marketplace_MaxPageUpdate()
        {
            if ((MediaId)this.cat_select.SelectedItem == null)
                return;
            int num = (int)Math.Ceiling((Decimal)(Constants.BindingLists.Categorys[Constants.BindingLists.Categorys.IndexOf((MediaId)this.cat_select.SelectedItem)].TotalCount + 1) / this.entrys_num.Value);
            if ((Decimal)num < this.page_num.Value)
                this.page_num.Value = (Decimal)num;
            this.page_num.Maximum = (Decimal)num;
        }
        ...
        {
            this.contentview.AutoResizeColumns(BetterListViewColumnHeaderAutoResizeStyle.ColumnContent);
            this.contentview.Columns.ToArray<BetterListViewColumnHeader>()[1].AutoResize(BetterListViewColumnHeaderAutoResizeStyle.HeaderSize);
        }
        ...
        private void marketplace_go_btn_Click(object sender, EventArgs e)
        {
            try
            {
                this.cat_sync_label.Text = ((MediaId)this.cat_select.SelectedValue).Name;
                this._helper.SubmitQuery();
            }
            catch (Exception ex)
            {
        ...
        {
            if (!(this.page_num.Value > this.page_num.Minimum))
                return;
            this.page_num.Value -= 1M;
            this.marketplace_go_btn_Click(sender, e);
        }

        private void marketplace_next_btn_Click(object sender, EventArgs e)
        {
            if (!(this.page_num.Value < this.page_num.Maximum))
                return;
            this.page_num.Value += 1M;
            this.marketplace_go_btn_Click(sender, e);
        }
        ...
        {
            MarketPlaceContent selectedValue = (MarketPlaceContent)this.contentview?.SelectedValue;
            ...
            extraInformation.gamecapabilityview.DataSource = (object)selectedValue?.Capabilities?.GameCapabilityInfo;
            foreach (BetterListViewColumnHeader column in (BetterListViewElementCollection<BetterListViewColumnHeader>)extraInformation.gamecapabilityview.Columns)
        ...
        {
            this._batchhandler.Abort();
            this._batchhandler.StartUrlCheck(true);
        }
        ...
        private void marketplace_directdownload_btn_Click(object sender, EventArgs e)
        {
            ...
            if (!selectedValue.CanDownload.IsTrue())
                return;
            DownloadInstance downloadInstance = new DownloadInstance(selectedValue.DownloadUrl, BindingStrings.Instance.DownloadPath + "\\" + selectedValue.Title.MakeFileSystemSafe() + ".xcp", (PackageBase)selectedValue);
            this._downloads.Add(downloadInstance);
            if (this._downloads.All<DownloadInstance>((Func<DownloadInstance, bool>)(d => d.DLStatus != DownloadStatus.Downloading)))
                downloadInstance.StartDownload();
            downloadInstance.ProgressChanged += new DownloadProgressChangedEventHandler(this.download_Contentdl_ProgressChanged);
            downloadInstance.DownloadFileCompleted += new AsyncCompletedEventHandler(this.download_Contentdl_DownloadFileCompleted);
        }

        private void settings_init()
        {
            this.decompress_path_tb.DataBindings.Add("Text", (object)BindingStrings.Instance, "DecompressPath");
            this.iso_path_tb.DataBindings.Add("Text", (object)BindingStrings.Instance, "IsoPath");
            this.download_path_tb.DataBindings.Add("Text", (object)BindingStrings.Instance, "DownloadPath");
        ...
        private void decompress_path_browse_btn_Click(object sender, EventArgs e)
        {
            ...
            this.decompress_path_tb_Validated((object)this.iso_path_tb, new EventArgs());
        }
        ...
        private void download_path_browse_btn_Click(object sender, EventArgs e)
        {
            ...
            this.download_path_tb_Validated((object)this.download_path_tb, new EventArgs());
        }
        ...
        private void iso_path_browse_btn_Click(object sender, EventArgs e)
        {
            ...
            this.iso_path_tb_Validated((object)this.iso_path_tb, new EventArgs());
        }
        ...
        {
            if (this.ThanksBox == null || this.ThanksBox.IsDisposed)
            {
                this.ThanksBox = new AboutBox(Constants.Credits);
                this.ThanksBox.Show();
            }
            else
                this.ThanksBox.Show();
        ...
        private void downloadmanager_controls_Remove_btn_Click(object sender, EventArgs e)
        {
            try
            {
                foreach (BetterListViewItem betterListViewItem in this.downloadmanager_blv.Items.Where<BetterListViewItem>((Func<BetterListViewItem, bool>)(obj => ((DownloadInstance)obj.Value).DLStatus == DownloadStatus.Finished)).ToList<BetterListViewItem>())
                    this.downloadmanager_blv.Items.Remove(betterListViewItem);
            }
            catch (Exception ex)
            {
                Console.Write(ex.ToString());
        ...
        {
            if (this.contentview.Items.Count <= 0)
                return;
            this.contentview.SelectedValue = this.contentview.Items[0].Value;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.cat_select.Size = new System.Drawing.Size(114, 21);
            ...
            this.entrypp_label.Location = new System.Drawing.Point(123, 0);
            ...
            // entrys_num
            // 
            this.entrys_num.Location = new System.Drawing.Point(170, 3);
